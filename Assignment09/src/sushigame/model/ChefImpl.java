...
public class ChefImpl implements Chef, BeltObserver {
	...
	private double foodCustomersConsumed = 0.0; 
	private double foodExpired = 0.0;
	...
	@Override
	public double getFoodCustomersConsumed() {
		return  foodCustomersConsumed;
	}

	@Override
	public double getFoodExpired() {
		return foodExpired;
	}
}
