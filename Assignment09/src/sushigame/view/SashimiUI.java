...
public class SashimiUI extends JPanel{
	
	public enum SashimiType {SHRIMP,TUNA, EEL,SALMON,CRAB};
	...
	private SashimiType sashimiSeafood;
	...
	protected SashimiUI() {
		...
		sashimi = new JLabel ("sashimi", SwingConstants.CENTER);
		...
		crab.addActionListener(new ActionListener() {
			public void actionPerformed (ActionEvent e) {
				text.setText("crab");
				sashimiSeafood= SashimiType.CRAB;
			}
		});
		...
		eel.addActionListener(new ActionListener() {
			public void actionPerformed (ActionEvent e) {
				text.setText("eel");
				sashimiSeafood= SashimiType.EEL;
			}
		});
		...
		salmon.addActionListener(new ActionListener() {
			public void actionPerformed (ActionEvent e) {
				text.setText("salmon");
				sashimiSeafood= SashimiType.SALMON;
			}
		});
		...
		shrimp.addActionListener(new ActionListener() {
			public void actionPerformed (ActionEvent e) {
				text.setText("shrimp");
				sashimiSeafood= SashimiType.SHRIMP;
			}
		});
		...
		tuna.addActionListener(new ActionListener() {
			public void actionPerformed (ActionEvent e) {
				text.setText("tuna");
				sashimiSeafood= SashimiType.TUNA;
			}
		});
